...
// ../.wrangler/tmp/bundle-KGrLUU/checked-fetch.js
...
function hasSubInstructorAccess(rawValue, userId) {
  ...
  const matches = /* @__PURE__ */ __name((value) => String(value || "").trim() === targetId, "matches");
...
__name(uniqueStrings2, "uniqueStrings");
...
__name(buildNotInClause2, "buildNotInClause");
...
__name(loadRevenueByRange2, "loadRevenueByRange");
...
__name(uniqueStrings3, "uniqueStrings");
...
__name(dedupeBySignature2, "dedupeBySignature");
...
__name(blacklistSignature2, "blacklistSignature");
...
__name(refundSignature2, "refundSignature");
...
__name(uniqueStrings4, "uniqueStrings");
...
__name(normalizeBoolean3, "normalizeBoolean");
...
// ../.wrangler/tmp/pages-sUr7xg/functionsRoutes-0.4940683096004679.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-KGrLUU/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-KGrLUU/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.5124223222267719.mjs.map
