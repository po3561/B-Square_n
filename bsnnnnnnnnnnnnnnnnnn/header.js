...
(function () {
    ...
    function renderOperatorMenu() {
        ...
        document.querySelectorAll('#userMenu').forEach(menuEl => {
            menuEl.innerHTML = `
                <a href="${prefix}admin_dashboard/admin.html" class="user-profile-btn" style="text-decoration:none;">
                ...
                <a href="${prefix}admin_dashboard/admin.html" class="btn-login-main" style="background: linear-gradient(135deg, #1e1e2d, #2c2c44); color:#fff; padding:6px 14px; margin-left:10px; font-size:0.85rem; border-radius:12px; box-shadow: 0 4px 10px rgba(0,0,0,0.2); border:1px solid #444;">운영 관리자 대시보드</a>
                <button type="button" class="btn-logout" onclick="handleGlobalLogout()" style="color:var(--text-secondary);font-size:0.8rem;background:none;border:none;cursor:pointer;margin-left:10px;">로그아웃</button>
            `;
        });
    }
