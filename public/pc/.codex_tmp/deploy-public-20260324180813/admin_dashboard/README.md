...
## 🛠️ 주요 기능
1. **보안 및 접근 제어**: Cloudflare Pages Functions 세션과 관리자 Role 기준으로 접근 제어를 수행합니다.
2. **통계 집계**: D1에 저장된 방문자/주문/회원 데이터를 기준으로 대시보드 통계를 표시합니다.
3. **데이터 통합**: 사용자, 결제, 설정, 클래스 관리 데이터를 모두 D1 기반 API로 통합합니다.
